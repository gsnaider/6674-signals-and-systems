...
def exercise(glottal_pulse, t, fs, f0, new_f0_pct, vowel_params, letter, plot=False):
    ...
    wav.write("../data/ex13/%s_f0_%d.wav" % (letter, new_f0_pct * 100), fs, new_x)
...
if __name__ == "__main__":
    ...
    exercise(glot, t, fs, f0, 1.5, A_PARAMS, 'A')
    exercise(glot, t, fs, f0, 1.5, E_PARAMS, 'E')
    exercise(glot, t, fs, f0, 1.5, I_PARAMS, 'I')
    exercise(glot, t, fs, f0, 1.5, O_PARAMS, 'O')
    exercise(glot, t, fs, f0, 1.5, U_PARAMS, 'U')
